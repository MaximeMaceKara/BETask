...
export default class Scene11 extends Phaser.Scene {
    ...
    create() {
        ...
        cadres.create(700,150,'scene1').setScale(gameOptions.imageSize);
        cadres.create(700,450,'scene2').setScale(gameOptions.imageSize);
        cadres.create(1150,150,'scene3').setScale(gameOptions.imageSize);
        cadres.create(1150,450,'scene4').setScale(gameOptions.imageSize);
