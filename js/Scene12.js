...
export default class Scene12 extends Phaser.Scene {
    ...
    create() {
        ...
        cadres.create(700,150,'preuve1').setScale(gameOptions.imageSize);
        cadres.create(700,450,'preuve2').setScale(gameOptions.imageSize);
        cadres.create(1150,150,'preuve3').setScale(gameOptions.imageSize);
        cadres.create(1150,450,'preuve4').setScale(gameOptions.imageSize);
