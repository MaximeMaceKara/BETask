...
export default class Scene15 extends Phaser.Scene {
    ...
    create() {
        ...
        cadres.create(700,150,'circuit1').setScale(gameOptions.imageSize);
        cadres.create(700,450,'circuit2').setScale(gameOptions.imageSize);
        cadres.create(1150,150,'circuit3').setScale(gameOptions.imageSize);
        cadres.create(1150,450,'circuit4').setScale(gameOptions.imageSize);
