...
export default class Scene19 extends Phaser.Scene {
    ...
    create() {
        ...
        cadres.create(700,150,'voie1').setScale(gameOptions.imageSize);
        cadres.create(700,450,'voie2').setScale(gameOptions.imageSize);
        cadres.create(1150,150,'voie3').setScale(gameOptions.imageSize);
        cadres.create(1150,450,'voie4').setScale(gameOptions.imageSize);
