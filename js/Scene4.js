...
export default class Scene4 extends Phaser.Scene {
    ...
    create() {
        ...
        cadres.create(700,150,'bruit1').setScale(gameOptions.imageSize);
        cadres.create(700,450,'bruit2').setScale(gameOptions.imageSize);
        cadres.create(1150,150,'bruit3').setScale(gameOptions.imageSize);
        cadres.create(1150,450,'bruit4').setScale(gameOptions.imageSize);
