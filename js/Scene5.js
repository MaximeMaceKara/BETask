...
export default class Scene5 extends Phaser.Scene {
    ...
    create() {
        ...
        cadres.create(700,150,'balle1').setScale(gameOptions.imageSize);
        cadres.create(700,450,'balle2').setScale(gameOptions.imageSize);
        cadres.create(1150,150,'balle3').setScale(gameOptions.imageSize);
        cadres.create(1150,450,'balle4').setScale(gameOptions.imageSize);
