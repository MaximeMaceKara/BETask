...
export default class Scene18 extends Phaser.Scene {
    ...
    create() {
        ...
        cadres.create(700,150,'piqure1').setScale(gameOptions.imageSize);
        cadres.create(700,450,'piqure2').setScale(gameOptions.imageSize);
        cadres.create(1150,150,'piqure3').setScale(gameOptions.imageSize);
        cadres.create(1150,450,'piqure4').setScale(gameOptions.imageSize);
