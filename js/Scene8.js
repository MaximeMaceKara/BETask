...
export default class Scene8 extends Phaser.Scene {
    ...
    create() {
        ...
        cadres.create(700,150,'gorge1').setScale(gameOptions.imageSize);
        cadres.create(700,450,'gorge2').setScale(gameOptions.imageSize);
        cadres.create(1150,150,'gorge3').setScale(gameOptions.imageSize);
        cadres.create(1150,450,'gorge4').setScale(gameOptions.imageSize);
