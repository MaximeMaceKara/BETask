...
export default class Scene10 extends Phaser.Scene {
    ...
    create() {
        ...
        cadres.create(700,150,'rond1').setScale(gameOptions.imageSize);
        cadres.create(700,450,'rond2').setScale(gameOptions.imageSize);
        cadres.create(1150,150,'rond3').setScale(gameOptions.imageSize);
        cadres.create(1150,450,'rond4').setScale(gameOptions.imageSize);
