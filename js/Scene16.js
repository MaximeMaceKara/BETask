...
export default class Scene16 extends Phaser.Scene {
    ...
    create() {
        ...
        cadres.create(700,150,'long1').setScale(gameOptions.imageSize);
        cadres.create(700,450,'long2').setScale(gameOptions.imageSize);
        cadres.create(1150,150,'long3').setScale(gameOptions.imageSize);
        cadres.create(1150,450,'long4').setScale(gameOptions.imageSize);
