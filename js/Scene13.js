...
export default class Scene13 extends Phaser.Scene {
    ...
    create() {
        ...
        cadres.create(700,150,'precis1').setScale(gameOptions.imageSize);
        cadres.create(700,450,'precis2').setScale(gameOptions.imageSize);
        cadres.create(1150,150,'precis3').setScale(gameOptions.imageSize);
        cadres.create(1150,450,'precis4').setScale(gameOptions.imageSize);
