 ...
 */
export default class Scene23 extends Phaser.Scene {
    /**
     * Constructor
     */
    constructor() {
    ...
    create() {
        ...
        cadres.create(700,150,'barriere1').setScale(gameOptions.imageSize);
        cadres.create(700,450,'barriere2').setScale(gameOptions.imageSize);
        cadres.create(1150,150,'barriere3').setScale(gameOptions.imageSize);
        cadres.create(1150,450,'barriere4').setScale(gameOptions.imageSize);
