...
export default class Scene9 extends Phaser.Scene {
    ...
    create() {
        ...
        cadres.create(700,150,'paquet1').setScale(gameOptions.imageSize);
        cadres.create(700,450,'paquet2').setScale(gameOptions.imageSize);
        cadres.create(1150,150,'paquet3').setScale(gameOptions.imageSize);
        cadres.create(1150,450,'paquet4').setScale(gameOptions.imageSize);
