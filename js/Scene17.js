...
export default class Scene17 extends Phaser.Scene {
    ...
    create() {
        ...
        cadres.create(700,150,'reunion1').setScale(gameOptions.imageSize);
        cadres.create(700,450,'reunion2').setScale(gameOptions.imageSize);
        cadres.create(1150,150,'reunion3').setScale(gameOptions.imageSize);
        cadres.create(1150,450,'reunion4').setScale(gameOptions.imageSize);
