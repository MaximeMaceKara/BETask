 ...
 */
export default class Scene22 extends Phaser.Scene {
    /**
     * Constructor
     */
    constructor() {
    ...
    create() {
        ...
        cadres.create(700,150,'conduire1').setScale(gameOptions.imageSize);
        cadres.create(700,450,'conduire2').setScale(gameOptions.imageSize);
        cadres.create(1150,150,'conduire3').setScale(gameOptions.imageSize);
        cadres.create(1150,450,'conduire4').setScale(gameOptions.imageSize);
