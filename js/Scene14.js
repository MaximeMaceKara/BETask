...
export default class Scene14 extends Phaser.Scene {
    ...
    create() {
        ...
        cadres.create(700,150,'precisrail1').setScale(gameOptions.imageSize);
        cadres.create(700,450,'precisrail2').setScale(gameOptions.imageSize);
        cadres.create(1150,150,'precisrail3').setScale(gameOptions.imageSize);
        cadres.create(1150,450,'precisrail4').setScale(gameOptions.imageSize);
