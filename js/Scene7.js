...
export default class Scene7 extends Phaser.Scene {
    ...
    create() {
        ...
        cadres.create(700,150,'chance1').setScale(gameOptions.imageSize);
        cadres.create(700,450,'chance2').setScale(gameOptions.imageSize);
        cadres.create(1150,150,'chance3').setScale(gameOptions.imageSize);
        cadres.create(1150,450,'chance4').setScale(gameOptions.imageSize);
