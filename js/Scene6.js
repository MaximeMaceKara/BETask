...
export default class Scene6 extends Phaser.Scene {
    ...
    create() {
        ...
        cadres.create(700,150,'soulever1').setScale(gameOptions.imageSize);
        cadres.create(700,450,'soulever2').setScale(gameOptions.imageSize);
        cadres.create(1150,150,'soulever3').setScale(gameOptions.imageSize);
        cadres.create(1150,450,'soulever4').setScale(gameOptions.imageSize);
